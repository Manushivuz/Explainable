...
export default function Dashboard() {
  ...
  useEffect(() => {
    axios.get('https://explainmyloan.onrender.com//getstats') // Change to your backend URL
      .then((res) => {
              ...
              <div className="grid grid-cols-2 gap-4">
                {!stats ? (
                  ...
                  [
                    ...
                    { label: 'Avg Credit Score', value: stats.averagecredit.toFixed(4) },
                    { label: 'Avg Interest Rate', value: `${stats.averageinterest.toFixed(4)}%` },
